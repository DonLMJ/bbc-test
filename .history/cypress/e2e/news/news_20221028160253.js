...
Then('I can see signIn prompt', () => {
    ...
    //with as bit more time I would have picked the signIn button which I would need in a test where a no logged in user land back to the comments after loggin in
